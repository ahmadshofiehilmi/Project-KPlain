package adam.notebook.example.com.kpproject6.module.list.CategoryKeyboard;
...
public class KeyboardCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyboard_category);bottomsheetlayout_list = (LinearLayout) findViewById(R.id.bottomsheetlist);
        ...
        KeyboardAdapter adapter = new KeyboardAdapter(this);
