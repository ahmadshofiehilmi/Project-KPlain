...
public class MoboAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS ROG Mobo","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public MoboAdapter(Context ctx) {
        this.mContex = ctx;
    }
