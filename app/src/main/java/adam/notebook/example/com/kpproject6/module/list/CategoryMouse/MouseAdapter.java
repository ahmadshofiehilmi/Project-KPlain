package adam.notebook.example.com.kpproject6.module.list.CategoryMouse;
...
public class MouseAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS ROG mouse","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public MouseAdapter(Context ctx) {
        this.mContex = ctx;
    }
