package adam.notebook.example.com.kpproject6.module.list.CategoryMobo;
...
public class MoboCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobo_category);bottomsheetlayout_list = (LinearLayout) findViewById(R.id.bottomsheetlist);
        ...
        MoboAdapter adapter = new MoboAdapter(this);
