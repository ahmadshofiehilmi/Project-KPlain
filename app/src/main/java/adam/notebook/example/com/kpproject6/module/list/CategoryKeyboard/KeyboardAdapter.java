...
public class KeyboardAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS ROG keyboard","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public KeyboardAdapter (Context ctx) {
        this.mContex = ctx;
    }
