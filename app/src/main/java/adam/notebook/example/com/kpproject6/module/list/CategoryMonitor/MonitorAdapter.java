package adam.notebook.example.com.kpproject6.module.list.CategoryMonitor;
...
public class MonitorAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS ROG monitor","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public MonitorAdapter(Context ctx) {
        this.mContex = ctx;
    }
