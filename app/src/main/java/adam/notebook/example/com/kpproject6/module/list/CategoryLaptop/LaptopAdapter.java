package adam.notebook.example.com.kpproject6.module.list.CategoryLaptop;
...
public class LaptopAdapter extends BaseAdapter { Context mContex;
    String [] name_product = {"ASUS ROG Laptop","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public LaptopAdapter (Context ctx) {
        this.mContex = ctx;
    }
