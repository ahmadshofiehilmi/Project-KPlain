package adam.notebook.example.com.kpproject6.module.list.CategoryPowerCable;
...
public class PowerCableAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS ROG power","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public PowerCableAdapter(Context ctx) {
        this.mContex = ctx;
    }
