package adam.notebook.example.com.kpproject6.module.list.CategoryCpu;
...
public class CpuAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS CPU","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
