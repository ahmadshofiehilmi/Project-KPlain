package adam.notebook.example.com.kpproject6.module.list.CategoryProcessor;
...
public class ProcessorAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS ROG Processor","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public ProcessorAdapter(Context ctx) {
        this.mContex = ctx;
    }
