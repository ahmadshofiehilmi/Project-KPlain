...
public class HdmiAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS ROG hdmi","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public HdmiAdapter(Context ctx) {
        this.mContex = ctx;
    }
