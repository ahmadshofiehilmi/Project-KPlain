package adam.notebook.example.com.kpproject6.module.list.CategoryPrinter;
...
public class PrinterAdapter extends BaseAdapter {
    Context mContex;
    String [] name_product = {"ASUS ROG printer","INTEL PROCESSOR","MOTHERBOARD ASUS","MONITOR GAMING","MOUSEPAD GAMING","HEADSET GAMING","GAMING CHAIR"};
    ...
    public PrinterAdapter(Context ctx) {
        this.mContex = ctx;
    }
