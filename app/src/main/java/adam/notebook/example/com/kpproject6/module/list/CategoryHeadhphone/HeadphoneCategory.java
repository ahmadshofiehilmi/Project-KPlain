...
public class HeadphoneCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_headphone_category);    bottomsheetlayout_list = (LinearLayout) findViewById(R.id.bottomsheetlist);
        ...
        HeadphoneAdapter adapter = new HeadphoneAdapter(this);
